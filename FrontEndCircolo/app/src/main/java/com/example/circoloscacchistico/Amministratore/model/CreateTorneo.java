...
public class CreateTorneo {

    // String nome_torneo,LocalDateTime data_torneo, String luogo, Integer numero_turni
    ...
    public CreateTorneo(String nome_torneo, String data_torneo, String luogo, Integer numero_turni) {
