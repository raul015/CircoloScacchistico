...
public class ModificaPartita extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_modifica_partita);
        context = this;
        ...
        call.enqueue(new Callback<ArrayList<ResponseGetTorneo>>() {
            ...
            public void onResponse(Call<ArrayList<ResponseGetTorneo>> call, Response<ArrayList<ResponseGetTorneo>> response) {
                ...
                if(response.code() != 200){
                    ...
                    Toast.makeText(ModificaPartita.this,"Errore 200, devo gestirlo ", Toast.LENGTH_SHORT).show();
                    return ;
                }
                ...
                try {
                    ...
                    listViewTornei = (ListView) findViewById(R.id.ListViewTorneiPartita);
                    ...
                    for (int i = 0; i < locale.size(); i++) { // già mi stampa i valori
                        ...
                        if(response.body().get(i).isIn_corso()== true){
                            // Vengono visti solo i tornei in corso....
                            listaTornei.add(response.body().get(i));
                        }
                    }

                    CustomTorneo custom = new CustomTorneo(listaTornei,ModificaPartita.this,R.layout.list_item1);
                    ...
                    listViewTornei.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(ModificaPartita.this,ModificaPartitaLista.class);
                ...
                Toast.makeText(ModificaPartita.this,"Successo! ", Toast.LENGTH_SHORT).show();

            }

            @Override
            public void onFailure(Call<ArrayList<ResponseGetTorneo>> call, Throwable t) {
                Toast.makeText(ModificaPartita.this,"Fallimento con il caricamento dei dati", Toast.LENGTH_SHORT).show();

            }
        });
    }

    public  void  BottoneUpdatePartiteTornei(View view){
        RichiestaListaTornei();
    }

    public void goToMainAdministrator(View view){
        Intent intent = new Intent(ModificaPartita.this,MainAmministratoreActivity.class);                            startActivity(intent);
        startActivity(intent);
