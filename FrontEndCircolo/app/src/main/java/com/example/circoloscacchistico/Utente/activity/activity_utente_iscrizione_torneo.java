...
public class activity_utente_iscrizione_torneo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_utente_iscrizione_torneo);
        ...
        call.enqueue(new Callback<ArrayList<ResponseGetTorneo>>() {
            ...
            public void onResponse(Call<ArrayList<ResponseGetTorneo>> call, Response<ArrayList<ResponseGetTorneo>> response) {
                ...
                if(response.code() != 200){
                    ...
                    Toast.makeText(activity_utente_iscrizione_torneo.this,"Errore 200, devo gestirlo ", Toast.LENGTH_SHORT).show();
                    return ;
                }
                ...
                try {
                    ...
                    for (int i = 0; i < locale.size(); i++) { // già mi stampa i valori
                        ...
                        if(response.body().get(i).isIn_corso() == false){
                            ...
                            System.out.println("il torneo " + response.body().get(i).getId()+" è in corso... " );
                        }
                    }

                    CustomTorneo custom = new CustomTorneo(listaTornei,activity_utente_iscrizione_torneo.this,R.layout.list_item1);
                    ...
                    listViewTornei.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(activity_utente_iscrizione_torneo.this, activity_utente_iscrizione_singolo_torneo.class);
                ...
                Toast.makeText( activity_utente_iscrizione_torneo.this,"Successo! ", Toast.LENGTH_SHORT).show();

            }

            @Override
            public void onFailure(Call<ArrayList<ResponseGetTorneo>> call, Throwable t) {
                Toast.makeText(activity_utente_iscrizione_torneo.this,"Fallimento con il caricamento dei dati", Toast.LENGTH_SHORT).show();

            }
        });
    }

    public  void  BottoneUpdateIscrizione(View view){
        RichiestaListaTornei();
    }

    public void goToMainUtent(View view){
        Intent intent = new Intent(activity_utente_iscrizione_torneo.this, MainUtenteActivity.class);                            startActivity(intent);
        startActivity(intent);
