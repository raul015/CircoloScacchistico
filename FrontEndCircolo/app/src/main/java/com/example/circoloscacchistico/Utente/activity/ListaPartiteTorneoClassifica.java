...
import com.example.circoloscacchistico.Amministratore.activity.VisualizzaClassifica;
...
import com.example.circoloscacchistico.Utente.UserPartitaAPICall;
...
public class ListaPartiteTorneoClassifica extends AppCompatActivity {
    ...
    private UserPartitaAPICall apiInterface;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_partite_torneo_classifica);
    ...
    public void richiestaListaClassifica(){
        ...
        apiInterface = retrofit.create(UserPartitaAPICall.class);
        ...
        call.enqueue(new Callback<ArrayList<ResponseClassifica>>() {
            ...
            public void onResponse(Call<ArrayList<ResponseClassifica>> call, Response<ArrayList<ResponseClassifica>> response) {
                ...
                if(response.code() != 200){
                    ...
                    Toast.makeText(ListaPartiteTorneoClassifica.this,"Errore 200, devo gestirlo ", Toast.LENGTH_SHORT).show();
                    return ;
                }
                ...
                try {
                    ...
                    CustomClassifica custom = new CustomClassifica(listaClassifica,ListaPartiteTorneoClassifica.this,R.layout.list_item_classifica);
                ...
                Toast.makeText(ListaPartiteTorneoClassifica.this,"Successo! ", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onFailure(Call<ArrayList<ResponseClassifica>> call, Throwable t) {
                Toast.makeText(ListaPartiteTorneoClassifica.this,"Fallimento con il caricamento dei dati", Toast.LENGTH_SHORT).show();
