...
public class ListaTorneiforVisualTurni extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_torneifor_visual_turni);
        ...
        call.enqueue(new Callback<ContenitoreInfoById>() {
            ...
            public void onResponse(Call<ContenitoreInfoById> call, Response<ContenitoreInfoById> response) {
                ...
                if(response.code() != 200){
                    // Gestione errore
                    Toast.makeText(ListaTorneiforVisualTurni.this,"Errore 200, devo gestirlo ", Toast.LENGTH_SHORT).show();
                    return ;
                }

                try {
                    contenitore = response.body();
                    listViewTornei = (ListView) findViewById(R.id.ListViewTorneiVisualTurno);
                    ...
                    CustomTorneo custom = new CustomTorneo(listaTornei,ListaTorneiforVisualTurni.this,R.layout.list_item1);
                    ...
                    listViewTornei.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            ...
                            Intent intent = new Intent(ListaTorneiforVisualTurni.this, ListaTurniTorneo.class);
                ...
                Toast.makeText(ListaTorneiforVisualTurni.this,"Successo! ", Toast.LENGTH_SHORT).show();

            }

            @Override
            public void onFailure(Call<ContenitoreInfoById> call, Throwable t) {
                Toast.makeText(ListaTorneiforVisualTurni.this,"Fallimento con il caricamento dei dati", Toast.LENGTH_SHORT).show();
    ...
    public void goToMainUtent(View view ){
        Intent intent = new Intent(ListaTorneiforVisualTurni.this, MainUtenteActivity.class);
        startActivity(intent);
    }
